...
#John F. Kennnedy, Laguardia, and Newark. 
```
...
nrow(nyc_geg)
```
What about missing destination codes?  Are there any destinations that do not look like valid airport codes
...
#It appears that winter has the most delays out of the four seaons. 
...
#I do not see any ethifcal or privacy concerns with my analysis because the data is 
...
#It the ncalculates the mean departure 
